...
import { useWallet, useProcessPayment } from "@/hooks/useWallet";
...
export default function MapPage() {
  ...
  const handleBookingConfirm = async (bookingData: BookingData) => {
    ...
    const totalFare = selectedRoute.fare * bookingData.passengerCount;
    ...
    try {
      ...
      const paymentResult = await processPayment.mutateAsync({
        amount: totalFare,
        description: `Pembayaran tiket rute ${selectedRoute.route_code}`,
